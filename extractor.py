...
ARTIST_USERNAME = 'theposearchives'
OUTPUT_FILE = 'public/gallery.json' # Guardar directamente en la carpeta de Next.js

# Verificación de seguridad
if not CLIENT_ID or not CLIENT_SECRET:
    raise ValueError("Faltan las credenciales de la API. Revisa tu archivo .env o GitHub Secrets.")
